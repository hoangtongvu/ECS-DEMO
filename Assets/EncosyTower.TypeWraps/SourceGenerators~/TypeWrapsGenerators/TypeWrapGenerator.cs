...
namespace EncosyTower.SourceGen.Generators.TypeWraps
{
    ...
    public class TypeWrapGenerator : IIncrementalGenerator
    {
        ...
        {
            context.RegisterPostInitializationOutput(EmitIWrap);
        ...
        private static void EmitIWrap(IncrementalGeneratorPostInitializationContext context)
        {
...
";
            ...
            context.AddSource("IWrap.g.cs", src);
        }
