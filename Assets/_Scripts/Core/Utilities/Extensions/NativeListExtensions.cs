...
namespace Core.Utilities.Extensions
{
    ...
    {
        [BurstCompile]
        public static void RemoveAtSwapBack<T>(this NativeList<T> list, int index)
            where T : unmanaged
        {
        ...
        [BurstCompile]
        public static void RemoveAtSwapBack<T>(this NativeList<T> list, int length, int index)
            where T : unmanaged
        {
