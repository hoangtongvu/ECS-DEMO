...
namespace Systems.Initialization.Unit.DarkUnit
{
    ...
    public partial class DarkUnitSpawnDurationMinutesInitSystem : SystemBase
    {
        ...
        protected override void OnUpdate()
        {
            ...
            su.AddOrSetComponentData(new DarkUnitSpawnDurationMinutes
            {
                Value = new(configsSO.SpawnDurationMinutes),
            });
