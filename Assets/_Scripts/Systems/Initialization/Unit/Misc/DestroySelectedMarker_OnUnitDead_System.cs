...
namespace Systems.Initialization.Unit.Misc
{
    ...
    [BurstCompile]
    public partial struct DestroySelectedMarker_OnUnitDead_System : ISystem
    {
        ...
        {
            var markerHolders = this.query.ToComponentDataArray<SelectedUnitMarkerHolder>(Allocator.Temp);
