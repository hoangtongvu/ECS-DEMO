...
namespace Systems.Initialization.UnitAndTool.RevertToBaseUnit.RevertRole
{
    ...
    [BurstCompile]
    public partial struct RevertUnitOnPick_Hammer_System : ISystem
    {
        [BurstCompile]
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            foreach (var (toolProfileIdHolderRef, unitProfileIdHolderRef, entity) in SystemAPI
                ...
                .WithEntityAccess())
            {
                if (toolProfileIdHolderRef.ValueRO.Value.ToolType != ToolType.Hammer) continue;
                RevertOnPick_Hammer(in ecb, ref unitProfileIdHolderRef.ValueRW, in entity);
            }
