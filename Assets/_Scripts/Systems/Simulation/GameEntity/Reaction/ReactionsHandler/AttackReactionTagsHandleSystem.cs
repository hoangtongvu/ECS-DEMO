...
namespace Systems.Simulation.GameEntity.Reaction.ReactionsHandler
{
    ...
    [BurstCompile]
    public partial struct AttackReactionTagsHandleSystem : ISystem
    {
        [BurstCompile]
        ...
        private partial struct ReactionTagsSetJob : IJobEntity
        {
            [BurstCompile]
            void Execute(
                EnabledRefRW<AttackReaction.StartedTag> reactionStartedTag
                , EnabledRefRO<AttackReaction.CanUpdateTag> reactionCanUpdateTag
                , EnabledRefRW<AttackReaction.UpdatingTag> reactionUpdatingTag
                , EnabledRefRW<AttackReaction.EndedTag> reactionEndedTag)
            {
