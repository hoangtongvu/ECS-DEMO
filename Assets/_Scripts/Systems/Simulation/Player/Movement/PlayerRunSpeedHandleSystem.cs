...
namespace Systems.Simulation.Player.Movement
{
    ...
    [BurstCompile]
    public partial struct PlayerRunSpeedHandleSystem : ISystem
    {
        [BurstCompile]
        ...
        [WithAll(typeof(RunReaction.UpdatingTag))]
        [BurstCompile]
        private partial struct SetTargetMoveSpeedJob : IJobEntity
        {
            ...
            {
                targetMoveSpeed.Value = playerReactionConfigsHolder.Value.RunSpeed;
            }
